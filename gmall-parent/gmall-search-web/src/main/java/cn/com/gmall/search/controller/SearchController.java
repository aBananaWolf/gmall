...
import cn.com.gmall.search.service.SearchService;
...
public class SearchController {
    ...
    public String list(PmsSearchParam pmsSearchParam, ModelMap modelMap) {
        ...
        if (pmsSearchParam.getValueId() != null) {
            ...
            searchValueId:for (Long delValueId : pmsSearchParam.getValueId()) {
                ...
                PmsBaseAttrInfo attrInfo = matchDelIterator.next();
                    ...
                    for (PmsBaseAttrValue pmsBaseAttrValue : attrInfo.getAttrValueList()) {
                        if (delValueId.equals(pmsBaseAttrValue.getId())) {
                            ...
                            HashMap<String, String> crumb = this.getCrumb(pmsSearchParam, delValueId, attrInfo.getAttrName()+"： <span style=color:red>"+pmsBaseAttrValue.getValueName());
                            crumbs.add(crumb);
    ...
    private HashMap<String, String> getCrumb(PmsSearchParam pmsSearchParam, Long currentValueId, String valueName) {
        ...
        crumb.put("urlParam",stringBuilder.toString());//urlParam valueName
        crumb.put("valueName",valueName);
//        crumb.put("sortCrumb",String.valueOf(currentValueId));
        return crumb;
    }
    private String getUrlParam(PmsSearchParam pmsSearchParam) {
        ...
        stringBuilder.append("&valueId=");
        if (pmsSearchParam.getValueId() != null) {
            Iterator<Long> iterator = pmsSearchParam.getValueId().iterator();
